...
class TrafficData(BaseModel):
    ...
    duration: float = 0.0            # Dur̩e connexion
    orig_bytes: float = 0.0          # Octets envoy̩s
    resp_bytes: float = 0.0          # Octets re̤us
    missed_bytes: float = 0.0        # Octets perdus
    orig_pkts: float = 1.0           # Paquets envoy̩s
    orig_ip_bytes: float = 0.0       # Octets IP source
    resp_pkts: float = 1.0           # Paquets re̤us
    resp_ip_bytes: float = 0.0       # Octets IP destination
    is_orig_local: int = 1           # IP locale (1) ou externe (0)
    orig_h_count: float = 1.0        # Fr̩quence IP source
    resp_h_count: float = 1.0        # Fr̩quence IP destination
